...
public class viewParams {
	 ...
	 * the shapes. The order of application is specified in the driver program.
	 *
	 * You will need to write this function, and maintain all of the values
	 * which must be sent to the vertex shader.
	 *
	 ...
	 */
	public void setUpTransforms(int program, GL2 gl2, float scaleX,
			float scaleY, float scaleZ, float rotateX, float rotateY,
			float rotateZ, float translateX, float translateY, float translateZ) {
