...
public class lightingParams {
	...
	private float ambientcolor[] = { 0.5f, 0.1f, 0.9f, 1.0f };
	private float diffusecolor[] = { 0.89f, 0.0f, 0.0f, 1.0f };
	private float specularcolor[] = { 1.0f, 1.0f, 1.0f, 1.0f };
	private float ka = 0.5f;
	private float kd = 0.7f;
	private float sreflection = 10.0f;
	private float ks = 1.0f;
	private float lightcolor[] = { 1.0f, 1.0f, 0.0f, 1.0f };
	private float lightposition[] = { 0.0f, 5.0f, 2.0f, 1.0f };
